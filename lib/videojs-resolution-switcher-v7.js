...
(function() {
  ...
  var ResolutionMenuItem = videojs.extend(MenuItem, {
    ...
    showAsLabel: function() {
      ...
      console.log('ResolutionMenuItem-showAsLabel')
      console.log('ResolutionMenuItem-showAsLabel', this.label, this.options_)
      if(this.label) {
        this.label.innerHTML = this.options_.label;
      }
    },
    onClick: function(customSourcePicker){
      console.log('ResolutionMenuItem-onClick')
    ...
    videoJsResolutionSwitcher = function(options) {
      console.log('videoJsResolutionSwitcher' ,options)
      ...
      console.log('videoJsResolutionSwitcher-settings' ,settings)
      /**
